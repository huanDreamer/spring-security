 ...
 */
@Component
public class ImageValidatorCodeGenerator implements ValidatorCodeGenerator<ImageCode> {

    private Integer codeLength = 4;

    @Override
    public ImageCode generatorCode(HttpServletRequest request, HttpServletResponse response) {
