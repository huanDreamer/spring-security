...
public class ValidateCodeFilter extends OncePerRequestFilter {
    ...
    private void validate(ServletWebRequest servletWebRequest) {
        ...
        ImageCode imageCode = (ImageCode) sessionStrategy.getAttribute(servletWebRequest, securityProperties.getBrowser().getSessionKey());
        ...
        if (imageCode.isExpired()) {
            sessionStrategy.removeAttribute(servletWebRequest, securityProperties.getBrowser().getSessionKey());
